...
public class CustomOauth2AuthorizationRequestResolver implements OAuth2AuthorizationRequestResolver {
    ...
    private OAuth2AuthorizationRequest resolve(HttpServletRequest request, String registrationId,
        ...
        String authorizationRequestUri = buildAuthorizationRequestUri();
...
//			parameters.put(OAuth2ParameterNames.CLIENT_ID, this.clientId);
        parameters.put("client_id", "f6c8cf4219b00a12dcb9696abbaaa4f7ef60b6219f38ecfa0b793cc0a7bff661");

        //parameters.put(OAuth2ParameterNames.SCOPE, StringUtils.collectionToDelimitedString(new HashSet<>(Arrays.asList("read")), " "));

        parameters.put(OAuth2ParameterNames.GRANT_TYPE, "authorization_code");


        parameters.put(OAuth2ParameterNames.STATE, "123");


        parameters.put(OAuth2ParameterNames.REDIRECT_URI, "http://127.0.0.1:8080/login/oauth2/code/gitee");
    ...
    private String buildAuthorizationRequestUri() {
        String authorizationUri = "https://gitee.com/oauth/authorize";
        ...
        UriBuilder uriBuilder = this.uriBuilderFactory.uriString(authorizationUri).queryParams(queryParams);
